...
public interface UserDao {
    ...
    User createUser(String username, String password, String firstName, String lastName, FileInputStream photo) throws SQLException, NoSuchAlgorithmException, IOException;
